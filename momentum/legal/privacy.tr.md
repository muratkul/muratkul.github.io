...
- **Transactional e-posta'lar** — Firebase Authentication, hesap
  güvenliği için aşağıdaki durumlarda e-posta adresinize otomatik
  ileti gönderir:
  - Kayıt sonrası **doğrulama** e-postası
  - Şifre sıfırlama talep ettiğinizde **sıfırlama bağlantısı**
  - Hesap işlemleri için güvenlik bildirimleri (gerektiğinde)
  Bu e-postaların içeriği biz tarafından oluşturulmaz; Firebase'in
  standart şablonları kullanılır. Pazarlama veya bülten e-postası
  göndermiyoruz.
