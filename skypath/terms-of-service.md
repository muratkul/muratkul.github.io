...
5. **Availability.** The game is provided "as is". We may update, change or
   discontinue features (never removing content you paid for while the app
   is available).
6. **Liability.** To the extent permitted by law, the developer is not
   liable for indirect damages arising from the use of the game.
7. **Contact.** nfvwzhbrbw@privaterelay.appleid.com

---

# Kullanım Koşulları (Türkçe özet)
...
5. Oyun "olduğu gibi" sunulur; ödediğiniz içerik uygulama yayında olduğu
   sürece kaldırılmaz.
6. İletişim: nfvwzhbrbw@privaterelay.appleid.com
